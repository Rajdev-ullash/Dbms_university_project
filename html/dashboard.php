...
<body>
    ...
    <div class="row m-3">
        ...
        if (isset($_POST['show'])) {
            ...
            $sql = "select u_id, ap_id,name,email,dob,department,drName,mobile from appoinments where u_id = $u_id";
            ...
            while ($row = mysqli_fetch_array($r)) {
                ...
                echo "<tr>
                        <td>$u_id</td><td>$ap_id</td><td>$name</td><td>$email</td><td>$dob</td><td>$department</td><td>$drName</td><td>$mobile</td>
                     </tr>";
            }
            echo "</table>";
        }
